// @flow strict
import { fullStackSkills, dataScienceSkills } from "@/utils/data/skills";
  ...
  return (
    <div id="skills" className="relative z-50 border-t my-12 lg:my-24 border-[#25213b]">
      ...
      <div className="w-full my-12">
        <h3 className="text-center text-2xl lg:text-3xl font-bold text-violet-400 mb-8">
          Full Stack Development
        </h3>
        <div className="flex flex-wrap justify-center gap-4 lg:gap-8">
          {fullStackSkills && fullStackSkills.map((skill, id) => (
      ...
      <div className="w-full my-12">
        ...
        <div className="flex flex-wrap justify-center gap-4 lg:gap-8">
          {dataScienceSkills && dataScienceSkills.map((skill, id) => (
            <div className="w-36 min-w-fit h-fit flex flex-col items-center justify-center transition-all duration-500 m-3 sm:m-5 rounded-lg group relative hover:scale-[1.15] cursor-pointer" key={id}>
              <div className="h-full w-full rounded-lg border border-[#1f223c] bg-[#11152c] shadow-none shadow-gray-50 group-hover:border-violet-500 transition-all duration-500">
                <div className="flex -translate-y-[1px] justify-center">
                  <div className="w-3/4">
